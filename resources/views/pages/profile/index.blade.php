...
@section('content')
        ...
        <div class="relative flex justify-center lg:justify-start">
            <div
                ...
                @else
                    ...
                    @endphp
                    <img src="https://ui-avatars.com/api/?name={{ $user_name }}" alt="User Avatar" class="w-full h-full object-cover">
                @endif
            </div>
        </div>
    ...
    <div class="container mx-auto mt-16">
        ...
        <div class="flex flex-col items-center lg:items-start gap-2">
            <div class="tooltip tooltip-bottom" data-tip="{{ \Carbon\Carbon::parse(Auth::user()->created_at)->format('d F Y h:i:s') }}">
